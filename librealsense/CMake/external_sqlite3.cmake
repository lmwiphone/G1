...
# [G1 vendored] 随包源码（sqlite amalgamation 3.49.1），存在时不联网下载
set(LRS_VENDORED_SQLITE3_DIR "${CMAKE_CURRENT_LIST_DIR}/../third-party/vendored/sqlite3")
if(NOT TARGET sqlite3 AND EXISTS "${LRS_VENDORED_SQLITE3_DIR}/sqlite3.c")
    include(ExternalProject)
    ExternalProject_Add(sqlite3
        SOURCE_DIR "${LRS_VENDORED_SQLITE3_DIR}"
        DOWNLOAD_COMMAND ""
        UPDATE_COMMAND ""
        CONFIGURE_COMMAND ""
        BUILD_COMMAND ""
