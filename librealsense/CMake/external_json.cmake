...
# [G1 vendored] 随包源码，存在时不联网下载
set(LRS_VENDORED_JSON_DIR "${CMAKE_CURRENT_LIST_DIR}/../third-party/vendored/json")

function(get_nlohmann_json)
    if(EXISTS "${LRS_VENDORED_JSON_DIR}/CMakeLists.txt")
        # 复制到原下载位置：rsutils 等处直接引用 ${CMAKE_BINARY_DIR}/third-party/json/include
        message( STATUS "Using vendored nlohmann/json: ${LRS_VENDORED_JSON_DIR}" )
        file( COPY "${LRS_VENDORED_JSON_DIR}/" DESTINATION "${CMAKE_BINARY_DIR}/third-party/json" )
