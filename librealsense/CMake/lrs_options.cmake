## [G1 vendored] 本副本随 lighting_ws 一起由 colcon 编译（包名 librealsense2），以下默认值与上游不同：
##   BUILD_WITH_NEON=OFF        -> 点云滤波器名为 "Pointcloud"，ROS 参数固定为 pointcloud.*（ON 时变成 pointcloud__neon_.*）
##   CHECK_FOR_UPDATES=OFF      -> 不依赖 libcurl/网络
##   BUILD_GLSL_EXTENSIONS / BUILD_EXAMPLES / BUILD_GRAPHICAL_EXAMPLES / BUILD_TOOLS = OFF -> 只编核心库，不依赖 OpenGL/glfw
##   第三方依赖（json/fastcdr/yaml-cpp/sqlite3）已放在 third-party/vendored/，离线可编译。
